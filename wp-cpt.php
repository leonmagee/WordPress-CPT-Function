...
/**
 * Class to create custom post types in your theme.
 * Include this file in your functions.php, and create new posts types by calling method
 *
 * @param $pt_name
 * @param $single_name
 * @param $plural_name
...
function mm_create_post_type(
	$pt_name, $single_name, $plural_name, $slug, $public = true,
...
/*  DECLARATION FUNCTION - ADD AN ENTRY FOR EACH CUSTOM POST TYPE
*
